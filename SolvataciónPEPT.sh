...
#  InterPEPT.sh
#  SCRIPT PARA EVALUAR LA INTERACCIÃ“N DE PÃ‰PTIDOS CON BICAPAS LIPÃDICAS
...
# DEFINIENDO PÃ‰PTIDOS A SIMULAR
...
# CREANDO LA CARPETA DEL PÃ‰PTIDO
mkdir $pept ; cd $pept

for memb in POPC #POPE POPG
do
...
# CREAR LA CAJA DE SIMULACIÃƒâ€œN DE LA MEMBRANA
trjconv_mpi -s em.tpr -f $memb.gro -o n-$memb.gro -pbc mol -ur compact <<EOF
2
EOF

# AUMENTANDO TAMAÃ‘O EN EL EJE Z
if [ $memb = POPC ];
then
...
# CREANDO EL ARCHIVO DE UNIÃ“N DE TOPOLOGÃAS
cp ~/CONFIG/UnirGRO.py ./

#CREAR LA CAJA CONJUNTA DE SIMULACIÃƒâ€œN
...
# CREACIÃ“N DEL ARCHIVO VDWRADII PARA SOLVATACIÃ“N
